...
parser = argparse.ArgumentParser(
    description="Heatmap region counting - no given region points"
)
...
cv2.namedWindow("Draw Polygon", cv2.WINDOW_GUI_NORMAL)
...
while cap.isOpened():
    ...
    if not success:
        ...
        break
    tracks = model.track(im0, persist=True, show=False, imgsz=800 * 6, classes=0)
